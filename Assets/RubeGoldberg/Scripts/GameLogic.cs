...
public class GameLogic : MonoBehaviour
{
	...
	{
        // Components
        GameObject temp1 = GameObject.Find("ControllerLayout");
        if (temp1 != null)
        {
    ...
    public void MoveViewPlayer(Vector2 joystickInput) // dont move player when scene transitiioning
    {
        if (sceneTransition == SceneTransition.complete && currentLevel != 0)
            player.MoveHead(joystickInput);
    }
